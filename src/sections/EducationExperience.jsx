                    ...
                    <div class="grid grid-cols-3 lg:grid-cols-5 gap-5 lg:gap-20">
                        ...
                        <section className="col-span-3">
                            <header className="pb-5 ml-16">
                                <h2 className="text-xl md:text-2xl font-semibold tracking-wide">EXPERIENCE</h2>
                            </header>

                            {/*Card Wrapper*/}
                            <div className="card-border relative rounded-xl p-3 flex flex-col gap-4 ml-10 md:ml-16">
                                {/*Timeline*/}
                                <span
                                    className="absolute w-6 h-6 md:w-8 md:h-8 rounded-full border-4 md:border-5 border-[#00ff55] -left-10 md:-left-16 top-14 z-60"/>
                                <div
                                    className="absolute -left-6.5  md:-left-11.5 top-22 md:top-24 h-[80%] w-[2px] md:w-[3px] rounded-full -translate-x-1 bg-[#00ff55] z-50"/>
                                {/*Content*/}
                                <div className="exp-card-wrapper ml-10 my-10 pe-6">
                                    <div className="flex items-start">
                                        <div className="expText flex xl:gap-20 md:gap-2 gap-5 relative z-20">
                                            <div>
                                                <h1 className="font-semibold text-2xl md:text-3xl">Software Engineer - Intern</h1>
                        ...
                        <section className="sm:col-span-2 col-span-3 mt-20 lg:mt-0">
                            <header className="pb-5 ml-16">
                                <h2 className="text-xl md:text-2xl font-semibold tracking-wide">EDUCATION</h2>
                            </header>
                            ...
                            <div className="card-border relative rounded-xl p-3 flex flex-col gap-4 ml-10 md:ml-16">
                                ...
                                <div
                                    className="absolute -left-6.5  md:-left-11.5 top-22 md:top-24 h-[105%] w-[2px] md:w-[3px] rounded-full -translate-x-1 bg-[#3385ff] z-50"/>
                                {/*Content*/}
                                <div className="exp-card-wrapper ml-10 my-10 pe-6">
                                    <div className="flex items-start">
                                        <div className="expText flex xl:gap-20 md:gap-2 gap-5 relative z-20">
                                            <div>
                                                <h1 className="font-semibold text-lg md:text-xl">BSc. (Hons) Degree in Information
                                                    Technology
                            ...
                            {/*Card Wrapper*/}
                            <div className="card-border relative rounded-xl p-3 flex flex-col gap-4 mt-15 ml-10 md:ml-16">
                                <span
                                    className="absolute w-6 h-6 md:w-8 md:h-8 rounded-full border-4 md:border-5 border-[#3385ff] -left-10 md:-left-16 top-14 z-60"/>
                                <div
                                ...
                                <div className="exp-card-wrapper ml-10 my-10 pe-6">
                                    <div className="flex items-start">
                                        <div className="expText flex xl:gap-20 md:gap-2 gap-5 relative z-20">
                                            <div>
                                                <h1 className="font-semibold text-lg md:text-xl">Diploma in IT
                                                    (International</h1>
                                                <p className="my-5 text-white-50">
